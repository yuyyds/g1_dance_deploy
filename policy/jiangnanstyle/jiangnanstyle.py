...
class jiangnanstyle(FSMState):
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        super().__init__()
        self.state_cmd = state_cmd
        self.policy_output = policy_output
        self.name = FSMStateName.SKILL_jiangnanstyle
        self.name_str = "jiangnanstyle"
        self.motion_phase = 0
        self.counter_step = 0
        self.ref_motion_phase = 0
        
        current_dir = os.path.dirname(os.path.abspath(__file__))
        config_path = os.path.join(current_dir, "config", "jiangnanstyle.yaml")
        with open(config_path, "r") as f:
            ...
            print("jiangnanstyle policy initializing ...")
