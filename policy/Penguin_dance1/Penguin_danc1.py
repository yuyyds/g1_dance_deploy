...
class Penguin_dance1(FSMState):
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        super().__init__()
        self.state_cmd = state_cmd
        self.policy_output = policy_output
        self.name = FSMStateName.SKILL_Penguin_dance1
        self.name_str = "Penguin_dance1"
        self.motion_phase = 0
        self.counter_step = 0
        ...
        with open(config_path, "r") as f:
            ...
            print("Penguin_dance1 policy initializing ...")
    ...
    def checkChange(self):
        if self.ref_motion_phase >= 1.0:  # 动作完成
            ...
            return FSMStateName.LOCOMODE  # 切换到 cooldown，然后会切换回 LOCO
        if(self.state_cmd.skill_cmd == FSMCommand.LOCO):
            ...
            self.state_cmd.skill_cmd = FSMCommand.INVALID
            return FSMStateName.SKILL_Penguin_dance1