...
class LocoMode(FSMState):
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        ...
        with open(config_path, "r") as f:
            ...
            # 设定过渡时间
            # 如果你希望冷却/平滑时间是 1 秒，就设为 50 (50 * 0.02s = 1s)
            # 如果觉得 0.6 秒够了，就设为 30
            self.TRANSITION_FRAMES = 75
    ...
    def run(self):
        ...
        # 6. 应用混合公式
        # 自动处理从 "Default Pose" 到 "Loco Pose" 的 1秒钟平滑过渡
    ...
    def checkChange(self):
        if(self.state_cmd.skill_cmd == FSMCommand.SKILL_1):
            ...
            return FSMStateName.SKILL_Kongfan
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_13):
            return FSMStateName.SKILL_Roundhouse_kick
        # elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_8):
        #     return FSMStateName.SKILL_Penguin_dance1(废弃)
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_9):
            return FSMStateName.SKILL_Penguin_dance4
            ...
            return FSMStateName.SKILL_guofucheng_dance
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_11):
            return FSMStateName.SKILL_45s_dance
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_12):
            return FSMStateName.SKILL_taiji
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_14):
            return FSMStateName.SKILL_dance2
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_15):
            return FSMStateName.SKILL_zoo_dance
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_16):
            return FSMStateName.SKILL_dahuajiao
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_17):
            return FSMStateName.SKILL_xinglian_dance1
        # elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_18):
        #     return FSMStateName.SKILL_pick_up_box
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_19):
            return FSMStateName.SKILL_jiangnanstyle
        elif(self.state_cmd.skill_cmd == FSMCommand.SKILL_20):
