...
class Getup_back(FSMState):
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        super().__init__()
        self.state_cmd = state_cmd
        self.policy_output = policy_output
        self.name = FSMStateName.GET_UP_BACK_MODE
        self.name_str = "Getup_back"
        self.motion_phase = 0
        self.counter_step = 0
        self.ref_motion_phase = 0
        
        current_dir = os.path.dirname(os.path.abspath(__file__))
        config_path = os.path.join(current_dir, "config", "Getup_back.yaml")
        with open(config_path, "r") as f:
            ...
            print("Getup_back policy initializing ...")
